package cn.ictt.zhanghui.springboot_test.base.filter;

import cn.ictt.zhanghui.springboot_test.base.exception.enums.BusinessResponseEnum;
import cn.ictt.zhanghui.springboot_test.base.util.http.JwtTokenUtils;
import cn.ictt.zhanghui.springboot_test.business.constants.SecurityConstants;
import cn.ictt.zhanghui.springboot_test.business.pojo.dto.JwtUser;
import cn.ictt.zhanghui.springboot_test.business.pojo.dto.LoginRequest;
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            ...
            if (e instanceof AuthenticationException) {
                BusinessResponseEnum.LOGIN_FAIL_EXCEPTION.assertFail();
            }
            BusinessResponseEnum.LOGIN_FAIL_EXCEPTION.assertFail(e);
            return null;
        }
    }
