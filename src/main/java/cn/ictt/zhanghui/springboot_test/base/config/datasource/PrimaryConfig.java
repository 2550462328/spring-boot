package cn.ictt.zhanghui.springboot_test.base.config.datasource;
...
@EnableJpaRepositories(
        ...
        basePackages = {"cn.ictt.zhanghui.springboot_test.service.domain.primary"}) //设置Repository所在位置*/
public class PrimaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("cn.ictt.zhanghui.springboot_test.domain.primary")
