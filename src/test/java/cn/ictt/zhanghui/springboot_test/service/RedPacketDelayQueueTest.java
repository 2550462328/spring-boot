...
import cn.ictt.zhanghui.springboot_test.common.queue.redis.RedPacketMessage;
 ...
 */
public class RedPacketDelayQueueTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(RedPacketDelayQueueTest.class);
